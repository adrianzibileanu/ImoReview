...
import com.imoreview.app.ImoReviewApp;
import com.imoreview.app.config.AsyncSyncConfiguration;
import com.imoreview.app.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ImoReviewApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
