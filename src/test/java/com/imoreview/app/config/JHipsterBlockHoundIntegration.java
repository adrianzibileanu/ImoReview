package com.imoreview.app.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.imoreview.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.imoreview.app.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
