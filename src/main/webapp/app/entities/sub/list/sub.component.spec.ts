...
describe('Sub Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sub', component: SubComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.subs?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to subService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getSubIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSubIdentifier).toHaveBeenCalledWith(entity);
